...
def query_tiers() -> list[CardLadderQuery]:
    return [
        ...
        CardLadderQuery("B", "Cade Cunningham Prizm PSA 10", 80, "weekly"),
        CardLadderQuery("B", "Jalen Williams Prizm PSA 10", 80, "weekly"),
        CardLadderQuery("B", "Brandon Miller Prizm PSA 10", 80, "weekly"),
        CardLadderQuery("B", "Amen Thompson Prizm PSA 10", 80, "weekly"),
        CardLadderQuery("B", "Ausar Thompson Prizm PSA 10", 80, "weekly"),
